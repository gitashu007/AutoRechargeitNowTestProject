...
public class RechargeTransactionTest extends TestCore{

	/*@Test(priority=0)
	public void testRechargeFlow_WithRechargeAmountOnly(){
	...
	public void testRechargeFlow_CouponPromoRINcash(){
		...
		PaymentPageWap paymentPage = new PaymentPageWap(driver);
		Assert.assertTrue(paymentPage.isRechargeAmountExpected(), "Payable amount is wrong on payment page");
		paymentPage.clickPDCCheckBox();
