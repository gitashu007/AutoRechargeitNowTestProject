...
public class DataRechargeTransactionTest extends TestCore{
	...
	@Test(priority=0)
	public void testDataRechargeFlow_CouponScen1(){
	    ...
	    Assert.assertTrue(receiptPage.isMobileNoSame(config.getProperty("Data_MobileNumber")),"Mobile no. is different on receipt page");
	...
	@Test(priority=2)
	public void testDataRechargeFlow_CouponPromoRINcashScen3(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=3)
	public void testDataRechargeFlow_CouponPromoRINcashPGScen4(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
		...
		Assert.assertTrue(receiptPage.isMobileNoSameScen1(config.getProperty("Data_MobileNumber")), "Recharged mobile no. is not correct");
	...
	@Test(priority=4)
	public void testDataRechargeFlow_CouponPromoScen6(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=5)
	public void testDataRechargeFlow_CouponPDCPromoPGScen7(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=6)
	public void testDataRechargeFlow_CouponRINcashPGScen8(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=7)
	public void testDataRechargeFlow_CouponPDCRINcashPGScen9(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=8)
	public void testDataRechargeFlow_CouponRincashPromoPDCScen10(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=9)
	public void testDataRechargeFlow_RINcashScen12(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=10)
	public void testDataRechargeFlow_RINPromoScen13(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=11)
	public void testDataRechargeFlow_RINPGScen14(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=12)
	public void testDataRechargeFlow_RINcashPDCScen15(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=13)
	public void testDataRechargeFlow_CouponRINcashPDCScen16(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=14)
	public void testDataRechargeFlow_RINcashPromoPGScen17(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=15)
	public void testDataRechargeFlow_RINcashPromoPDCScen18(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=16)
	public void testDataRechargeFlow_PDCRINcashPGScen19(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
	...
	@Test(priority=17)
	public void testDataRechargeFlow_PromoPGScen20(){
		HomePageWap homePage = new HomePageWap(driver);
		homePage.clickLuckyDrawCrossIcon();
		homePage.clickLoginButton();
